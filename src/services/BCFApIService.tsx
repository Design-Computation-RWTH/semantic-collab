...
import * as bcfOWL_API from "./types/bcfOWL_API_types";
...
class BCFAPIService {
  ...
  async getAllViewPoints(): Promise<bcfOWL_API.ViewPointType[]> {
  ...
  async getProjects(): Promise<bcfOWL_API.ProjectType[]> {
    const response = await fetch(
