...
class RepresentationDetails extends React.Component {
  ...
  render() {
    ...
    let storeys =
      Viewer_instance.metaScene.getObjectIDsByType("IfcBuildingStorey");
            ...
            <div className="col">
              ...
              <div className="input-group-prepend">
                ...
                <button
                  ...
                  onClick={() => {
                    let startDistance =
                      document.getElementById("current-distance").value;
                    let targetDistance =
            ...
            <button
              ...
              onClick={() => {
                ...
                if (this.props.selected_document !== "new_temp_plan") {
                  ...
                  imageService
                    .postFile(this.props.file, this.props.newfilename)
                    .then((message) => {
                      console.log(message);
