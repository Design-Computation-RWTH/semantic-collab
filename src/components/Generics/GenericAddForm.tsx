...
function GenericAddForm (props:GenericAddFormProps) {
    ...
    const submitted = (event: { preventDefault: () => void; }) => {
        ...
        props.onHide();
        PubSub.publish('Update', {txt: "Inserted "+props.bcfOWLProperty.trim() +" - "+ value.trim()});
                ...
                <Modal.Body className="show-grid">
                    <Form onSubmit={submitted}>
                        <Form.Group className="mb-3" controlId="formProjectName">
                            <Form.Control type="text" onChange={handleValue} placeholder={"Enter new "+props.item+" value "}/>
                        </Form.Group>
